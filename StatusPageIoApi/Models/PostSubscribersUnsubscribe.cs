...
namespace StatusPageIoApi {
  ...
  /// </summary>
  public class PostSubscribersUnsubscribe {
    ...
    public PostSubscribersUnsubscribeType Type { get; set; }
    ...
    [JsonProperty("state")]
    [JsonConverter(typeof(StringEnumConverter))]
    public PostSubscribersUnsubscribeState State { get; set; } =
      PostSubscribersUnsubscribeState.Active;
